...
import coverFive from "../Contents/images/servicesImages/coversFive.jpg"
              ...
              <Row>
                ...
                <Col sm={12} md={12} lg={6}>
                  <div className="imageWrapper">
                    ...
                    <img alt="cover four" src={coverFive} style={{height: "292px"}}/>
                  </div>
                </Col>
              </Row>
            </div>
      ...
      <div className="servicesContent">
        ...
        <div className="coversContent">
          <div className="coversWrapper">
            <Row>
              <Col sm={12} md={12} lg={6} style={{ marginTop: "30px" }}>
                <p className="servicesText">- We offer a refurbishment service, recovering existing and old upholstery to modernise and refresh your boat.</p>
                <br/>
                <p className="servicesText">
